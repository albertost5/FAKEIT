 ...
 */
final class Version20201004185222 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE item ADD user_id INT DEFAULT NULL, ADD date DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE item DROP user_id, DROP date');
    }
}
